...
namespace IntelligentPx.Controls
{
    ...
    public class AutoCompleteView : ContentView
    {
        ...
        /// </summary>
        public static readonly BindableProperty SuggestionsProperty = BindableProperty.Create<AutoCompleteView, IEnumerable>(p => p.Suggestions, null, propertyChanged: SuggestionsValueChanged);
        ...
        private static void SuggestionsValueChanged(BindableObject obj, IEnumerable oldvalue, IEnumerable newvalue)
        {
            var control = (AutoCompleteView) obj;
            TextValueChanged(obj, control.Text, control.Text);
        }
